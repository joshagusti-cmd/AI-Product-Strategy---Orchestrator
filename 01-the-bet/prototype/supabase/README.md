...
- **Orchestrate is gated to any signed-in user**, not to a specific plan/quota — there's no per-workspace rate limiting or spend cap on the real Claude calls yet, just the requirement to be signed in at all.
